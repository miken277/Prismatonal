...
export const ATMOSPHERE_PATCHES = [
    ...
    p("Industrial", "Atmosphere",
        ...
        // Osc 3: Steam/Noise (Saw LFO on Amp) - REDUCED GAIN
        { enabled: true, waveform: WaveformType.NOISE, gain: 0.08, filterType: 'highpass', filterCutoff: 3000, lfoWaveform: 'sawtooth', lfoRate: 0.5, lfoDepth: 100, lfoTarget: 'tremolo' },
